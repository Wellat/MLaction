...
print(browse_history_train.head(5))
...
##训练准确率
#score = knn.score(train_X, train_y)#0.891964205414156
##预测
#pred = knn.predict_proba(test)
'''tree'''
...
#准确率
score= clf.score(train_X, train_y)#0.99999
...
print(result.head(5))
# 输出结果
result.to_csv('../output/tree_result.csv')
